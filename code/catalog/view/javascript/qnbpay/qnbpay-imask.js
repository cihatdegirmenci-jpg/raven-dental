(function(t, e) {
            ...
            return J(t, [{
                ...
                value: function(t, e) {
                    for (var u = new ft, n = this.clone(), r = void 0, i = 0; i < t.length; ++i) {
                        ...
                        if (r = this.clone(), !(!a.overflow && !this._appendTail(e).overflow) || !1 === this.doValidate({
                                tail: !0
                            })) {
                            this.assign(n);
                            break
    ...
    var kt = function() {
        ...
        mt = function(t) {
            ...
            return tt(e, pt), J(e, [{
                ...
                key: "reset",
                value: function() {
                    Q(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "reset", this).call(this), this._charDefs.forEach(function(t) {
                        delete t.isHollow
                    })
                }
            }, {
                ...
                value: function(t) {
                    ...
                    return t && u.aggregate(t instanceof kt ? this._appendChunks(t.chunks, {
                        tail: !0
                    }) : Q(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "_appendTail", this).call(this, t)), u.aggregate(this._appendPlaceholder())
                }
            }, {
                key: "_append",
                value: function(t) {
    ...
    var Et = function() {
        ...
        return J(t, [{
            ...
            key: "updateOptions",
            value: function(t) {
                t = K({}, t), this.mask = t.mask, delete t.mask, function t(e, u) {
                    if (u === e) return !0;
    ...
    var bt = function(t) {
        ...
        Pt = function(t) {
            ...
            return tt(e, pt), J(e, [{
                key: "_update",
                value: function(t) {
                    Q(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "_update", this).call(this, t), this.compiledMasks = Array.isArray(t.mask) ? t.mask.map(function(t) {
                        return vt(t)
                    }) : []
                }
            }, {
                ...
                value: function(t) {
                    var u = new ft;
                    return t && u.aggregate(this._applyDispatch(t.value)), u.aggregate(this.currentMask ? this.currentMask._appendTail(t) : Q(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "_appendTail", this).call(this, t))
                }
            }, {
                key: "doCommit",
                value: function() {
